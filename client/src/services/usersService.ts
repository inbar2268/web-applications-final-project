...
export const deleteUser = (_id: string) => {
    return new Promise<IUser>((resolve, reject) => {
        apiClient.delete(`/users/${_id}`).then((response)=> {
            resolve(response.data)
        }).catch((error: AxiosError)=>{
            console.log(error)
...
export const getUserById = (_id: string) => {
    return new Promise<IUser>((resolve, reject) => {
        apiClient.get(`/users/${_id}`).then((response) => {
            resolve(response.data);
        }).catch((error) => {
            console.error(error);
...
export const getUserByUsername= (username: string) => {
    return new Promise<IUser>((resolve, reject) => {
        apiClient.get(`/users/username/${username}`).then((response) => {
            resolve(response.data);
        }).catch((error) => {
            console.error(error);
            reject("Failed to fetch user. Please try again.");
...
export const editUser = (_id: string, updatedData: Partial<IUser>) => {
    return new Promise<IUser>((resolve, reject) => {
        apiClient.put(`/users/${_id}`, updatedData).then((response) => {
            resolve(response.data);
        }).catch((error) => {
            console.error(error);
